            ...
            <template v-if="tickers.length">
                <div>
                    ...
                    <button
                            ...
                            v-if="hasNextPage"
                    >Впред</button>
                    <div>Фильтр: </div><input v-model="filter">
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            filteredTickers(){
                ...
                const data =  this.tickers.filter(item=>item.name.includes(this.filter));

                this.hasNextPage = data.length > end;
            ...
            async getTickerPrice(tickerName) {
                ...
                if (this.select && this.select.name == tickerName) {
